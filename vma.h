...
void initVulkanFunctions(void* getProcAddrPtr, VkInstance instance, VmaVulkanFunctions* funcs) {
	...
	funcs->vkGetBufferMemoryRequirements2KHR = (PFN_vkGetBufferMemoryRequirements2KHR)((*getProcAddr)(instance, "vkGetBufferMemoryRequirements2"));
	funcs->vkGetImageMemoryRequirements2KHR = (PFN_vkGetImageMemoryRequirements2KHR)((*getProcAddr)(instance, "vkGetImageMemoryRequirements2"));
}
